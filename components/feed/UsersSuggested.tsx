...
const UsersSuggested: FC<usersuggestedprops> = ({
  user,
  followers,
  sessionid,
}) => {
  ...
  return (
    <div className="flex justify-start items-center p-4 hover:bg-[#f2f2f2]">
      <Link
        ...
        className="decoration-transparent h-fit w-fit flex"
      >
        <Image
          src={user.image || ""}
          alt="user"
          ...
          loading="eager"
          priority
          className="max-h-[40px] rounded-full h-10 w-10 "
        />
        <div className="px-[10px]">
          <span className="text-sm text-[#393a4f] font-medium block ">
            {user.username}
          </span>
