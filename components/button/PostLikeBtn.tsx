...
const PostLikeBtn: FC<postlikebtnprops> = ({
  postData,
  isLiked,
  initialLikeAmt,
}) => {
    ...
    <>
      ...
      <div className="relative flex justify-start  items-center mx-1 ">
        <Button
          ...
          onClick={() => like()}
          variant="ghost"
          className=" -top-[58px] -left-4 absolute h-[50px] w-[50px]  border border-[crimson] bg-white flex justify-center items-center rounded-full shadow-lg outline-none transition-colors "
          style={{
            color: !liked ? "crimson" : "#fff",
            backgroundColor: !liked ? "#fff" : "crimson",
          }}
        >
        ...
        <Button
          className="h-fit w-fit p-0 outline-none"
          variant="ghost"
          isLoading={isLoading}
        >
          <AiFillHeart
            className="h-[18px] w-[18px]  "
            style={{ color: !liked ? "#888da8" : "crimson" }}
          />
        </Button>
