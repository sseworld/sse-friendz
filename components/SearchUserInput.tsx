...
function SearchUserInput() {
  ...
  const handleSearchDropdown = async (
  ...
  return (
    <div className="flex justify-center focus-within:shadow-lg  mb-0">
      <div className="relative w-full   ">
        <div className="absolute p-2 h-full grid items-center focus-within:text-[#039be5] ">
          <FiSearch className=" " />
        </div>
        ...
        <input
          ...
          placeholder="Search"
          className=" pr-1 outline-none border border-colorF7 bg-colorF7 w-full h-[42px] rounded-md pl-7 focus:bg-white focus:border-[#3180e1]  "
        />
